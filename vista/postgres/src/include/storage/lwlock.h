...
#define BUFFER_MAPPING_LWLOCK_OFFSET_POOL(i) \
	(NUM_INDIVIDUAL_LWLOCKS + (i) * NUM_BUFFER_PARTITIONS)
#define LOCK_MANAGER_LWLOCK_OFFSET		\
	(BUFFER_MAPPING_LWLOCK_OFFSET + N_POOLS * NUM_BUFFER_PARTITIONS)
#else
#define BUFFER_MAPPING_LWLOCK_OFFSET	NUM_INDIVIDUAL_LWLOCKS
#define LOCK_MANAGER_LWLOCK_OFFSET		\
...
#ifdef VISTA
    LWTRANCHE_BUFFER_SEGMENT_ENTRY,
    LWTRANCHE_SNAPSHOT_HASH,
