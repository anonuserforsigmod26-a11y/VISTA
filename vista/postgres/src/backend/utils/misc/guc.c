...
#ifdef VISTA
static const struct config_enum_entry session_workload_options[] = {
    {"OLTP", 0, false},
    {"OLAP", 1, false},
    {NULL, 0, false}
};
...
#ifdef VISTA
	{
		/* (VISTA) user may set the workload type(olap or oltp) of this seesion */
		{"session_workload", PGC_USERSET, UNGROUPED,
			gettext_noop("Session workload type: 'OLTP' or 'OLAP'."),
			NULL,
			GUC_NO_SHOW_ALL | GUC_NO_RESET_ALL | GUC_NOT_IN_SAMPLE
		},
		&session_workload,
		0, session_workload_options,
		NULL, NULL, NULL
	},
#endif
